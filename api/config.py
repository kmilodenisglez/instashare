...
class Settings(BaseSettings):
    ...
    IPFS_GATEWAY_URL: str = Field(
        ...
        description="IPFS gateway URL for accessing uploaded files. Recommended \
        to use own dedicated gateway to avoid congestion and rate limiting. Example: \
        'https://ipfs.my-dao.org/ipfs' (Note: won't work for third-party files)",
    )
